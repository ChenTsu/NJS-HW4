#GeeckBrains Node.js homework 4

<h3>Задание</h3>

<p>1. Создать на основе express и handlebars веб-сервис с HTMLинтерфейсом для динамической загрузки информации с одного из
...
должна ) отправляться на сервер методом POST.</p>

<p>2. Реализовать запоминание с помощью cookie текущих настроек
...
(например, ?count=10&lang=ru и т.д.)</p>